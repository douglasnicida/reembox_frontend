...
function VerifyAndApproveDialog({ reportStatus, currentReport }: VerifyAndApproveDialogProps) {
  ...
  async function handleApproval(approvedStatus: boolean) {
    const endpoint = (approvedStatus === true) ? `/reports/financial/admit/${currentReport.id}` : `/reports/approver/reject/${currentReport.id}`
...
export default function FinancialPage() {
    ...
    async function fetchReportsToApprove() {
      try {
        ...
        const { data } = await api.get("/reports/reportsToFinanceApprove");
