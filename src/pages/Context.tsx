...
function ContextPage() {
  ...
  const websocketRef = useRef<WebSocket | null>(null); // Ref para a conexão WebSocket
  ...
  // Inicializar o WebSocket na montagem do componente
  useEffect(() => {
    connectWebSocket();
    return () => {
  ...
  const handleSendMessage = (e: React.FormEvent<HTMLFormElement>) => {
    ...
    const userMessage = {
      id: messages.length + 1,
      avatar: `https://ui-avatars.com/api/?name=${user && user.name}&background=random&rounded=true&size=40`,
      role: "user",
      message: input,
    };
  ...
  // Atualizar o scroll para a última mensagem
  useEffect(() => {
